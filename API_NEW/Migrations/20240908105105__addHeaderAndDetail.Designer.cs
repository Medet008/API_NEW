...
namespace API_NEW.Migrations
{
    ...
    [Migration("20240908105105__addHeaderAndDetail")]
    partial class _addHeaderAndDetail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_NEW.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("API_NEW.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("API_NEW.Models.MenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("API_NEW.Models.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("API_NEW.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("API_NEW.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("API_NEW.Models.CartItem", b =>
                {
                    b.HasOne("API_NEW.Models.MenuItem", "MenuItem")
                        .WithMany()
                        .HasForeignKey("MenuItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API_NEW.Models.ShoppingCart", null)
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("API_NEW.Models.OrderDetails", b =>
                {
                    ...
                    b.HasOne("API_NEW.Models.OrderHeader", null)
            ...
            modelBuilder.Entity("API_NEW.Models.OrderHeader", b =>
                {
                    b.HasOne("API_NEW.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("API_NEW.Models.ApplicationUser", null)
                        .WithMany()
